                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="title" size="50" value="<?php echo ($res["title"]); ?>" type="text">
                                </td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>链接地址：</th>
                                <td>
                                    <input class="common-text required" id="title" name="url" size="50" value="<?php echo ($res["url"]); ?>" type="text">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="desc" size="50" value="<?php echo ($res["desc"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th></th>
